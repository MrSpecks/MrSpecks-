  ...
  <meta property="og:type" content="website" />
    ...
    <div className="absolute inset-0 bg-cover bg-center bg-no-repeat" 
      ...
      style={{ textShadow: '1px 1px 2px rgba(0,0,0,0.2)'}}>
        ...
        <motion.section 
          className="mb-8 px-4 py-10 max-w-4xl mx-auto text-center items-center bg-gradient-to-r from-blue-50/30 to-transparent dark:from-blue-900/20 rounded-xl shadow-inner"
